...
+ (void)getRed:(CGFloat *)rPtr green:(CGFloat *)gPtr blue:(CGFloat *)bPtr fromColor:(OSColor *)color
{
	...
	if (!done)
	{
		...
		CGContextRef context = CGBitmapContextCreate(&pixel, 1, 1, 8, 4, rgbColorSpace, (kCGBitmapAlphaInfoMask & kCGImageAlphaNoneSkipLast)|(kCGBitmapByteOrderMask & kCGBitmapByteOrderDefault));
